% -------------------------------------------------------------------------
% Main script for extracting confound time-series for WM and CSF
% -------------------------------------------------------------------------
clear
close all
clc
...
% Output file
f_out    = '/Users/maria/Documents/NSPN/analysis/ROIs_conf_nspn_wbic.mat';

% Directories
ex_scan  = spm_vol('/Users/maria/Documents/NSPN/data/fMRI/wbic/21620/20130708_U-ID28503/Series_005_MEPI2_AF2_38iso_3xTE_FA90deg/swracBOLD.nii,1');
    ...
    for s = 1:numel(subdir)
        ...
        for q = 1:numel(subsubdir)
            ...
            if ~isempty(strmepi) && t1_flag
                ...
                if i == 35 || i == 36 || i == 47 || i == 69 || i == 80 || i == 85 || i == 140 || i == 186 || i == 222 ,
