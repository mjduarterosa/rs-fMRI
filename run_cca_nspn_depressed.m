...
gender = gender(:,2:end);
genderd = csvread('/Users/maria/Documents/NSPN/docs/NSPN_gender_bin_depressed.csv');      % gender
genderd = genderd(:,2:end);

varsQconf = [varsQconf; varsQconfd];
mri_centre = [mri_centre; mri_centred];
gender = [gender; genderd];
